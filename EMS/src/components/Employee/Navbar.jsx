  ...
  return (
    ...
    <div className='h-18 px-10 bg-[#52658f] w-full flex justify-between items-center'>
      ...
      <div className="right flex gap-5 items-center">
        <button className='cursor-pointer flex items-center gap-1 rounded px-3 py-2 font-semibold bg-[#f7f5e6] text-[#333a56]' onClick={()=>navigate("/dashboard/employee/leave/apply")}> <FaPlus/>Apply Leave</button>
