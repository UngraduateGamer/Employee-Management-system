  ...
  return (
    <div className='w-[60%] h-[500px]  rounded-5xl  mx-auto flex flex-col justify-center gap-5  items-center relative z-2'>
        ...
        <div className='flex gap-5'>
            <button className='px-5 py-2 cursor-pointer text-lg bg-[#333a56] rounded-md text-[#e8e8e8]' onClick={()=>navigate("/signup")}>Get started</button>
            <button className='px-5 py-2 cursor-pointer text-lg bg-[#52658f] rounded-md text-[#e8e8e8]' onClick={()=>navigate("/login")}>Login</button>
        </div>
    </div>
  )
}
