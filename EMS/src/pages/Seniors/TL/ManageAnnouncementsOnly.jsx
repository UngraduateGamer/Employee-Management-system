...
const ManageAnnouncementsOnly = () => {
    ...
    useEffect(()=>{
        // fetch all announcement data (jiska role admin na ho)
      const annnouncementData = getAnnouncements().filter(ann => ann.role != 'admin');
...
export default ManageAnnouncementsOnly