                ...
                <main className='px-10 py-5'>
                    ...
                    <div className="bottom w-full h-fit p-8 bg-[#52658f] rounded my-5">
                        <div className='uppercase font-semibold px-8 py-3 rounded text-[#e8e8e8] flex justify-between text-left bg-[#333a56]'>
                            ...
                            <h4 className='text-left w-1/5'>salary</h4>
                            <h4 className='text-left w-1/5'>status</h4>
                        ...
                        <div className='capitalize  my-3 px-8 py-3 text-[#e8e8e8] flex justify-between text-left border-b rounded-none '>
                            <h4 className=' text-left w-2/5  '>july 1, 2025 to July 31, 2025</h4>
                            <h4 className='text-left w-1/5'>&#8377;20,000</h4>
                            
     <h4 className='w-1/5 text-left'><button className='bg-[#e8e8e8] rounded-full px-3 py-1 text-[#333a56] font-medium text-sm'>Accepted</button></h4>
     
     <h4 className='w-1/5 text-left cursor-pointer text-[#f7f5e6] font-semibold'>Download</h4>
